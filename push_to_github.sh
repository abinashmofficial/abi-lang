...
if command -v gh &> /dev/null && gh auth status &> /dev/null; then
    ...
    gh repo create abinashmofficial/abi-lang --public --source=. --remote=origin --push
    echo "Successfully created and pushed to: https://github.com/abinashmofficial/abi-lang"
else
    echo ""
    echo "--------------------------------------------------"
    ...
    echo "Step 2: Create a public repository named: abi-lang"
    echo "Step 3: Run these terminal commands to push your code:"
    echo ""
    echo "  git remote add origin https://github.com/abinashmofficial/abi-lang.git"
